 ...
 */
public class addVideo extends BaseActivity {
    Button event,space,element;
    Button btn,postbtn,youtubebtn;
    Bitmap bb;
    byte[] image;
    private Timer timer;
    ...
    RobotoTextView esm;
    Uri selectedimg;
    EditText nameedit,description_input,videourl_input;
    Spinner sp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // sp = (Spinner) findViewById(R.id.spinner2);
        ...
        description_input = (EditText) findViewById(R.id.input_description);
        videourl_input = (EditText) findViewById(R.id.input_url);
        btn = (Button) findViewById(R.id.phototagbtn);
        postbtn = (Button) findViewById(R.id.poostit);
        youtubebtn=(Button) findViewById(R.id.btnyoutube);
        ...
        youtubebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(addVideo.this, YoutubeActivity.class);
        ...
        postbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String VideoName = nameedit.getText().toString();
                String Description = description_input.getText().toString();
                String Url = videourl_input.getText().toString();
               // String genre = sp.getSelectedItem().toString();
                ParseFile fileimage = new ParseFile("VideoImage", image);
                ...
                parseObject.put("VideoName", VideoName);
                parseObject.put("VideoImage", fileimage);
                parseObject.put("VideoUrl",Url);
               ...
               // parseObject.put("Genre", genre);
                ...
                parseObject.saveInBackground(new SaveCallback() {
                    public void done(ParseException e) {
                        if (e == null) {
                            Toast.makeText(getApplicationContext(), "Video file saved successfully", Toast.LENGTH_SHORT).show();
                        } else {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent imageReturnedIntent) {
        ...
        switch (requestCode) {
            ...
            case 5:
                    ...
                    if(resultCode == RESULT_OK){
                        String stredittext=imageReturnedIntent.getStringExtra("arg");
                        videourl_input.setText(stredittext);
                    }
