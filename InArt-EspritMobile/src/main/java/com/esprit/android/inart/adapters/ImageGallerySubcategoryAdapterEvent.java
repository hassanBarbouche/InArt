...
public class ImageGallerySubcategoryAdapterEvent extends BaseAdapter /*implements OnClickListener*/ {
	...
	private ArrayList<EventElement> mImageGallerySubcategories;
	private final boolean mIsLayoutOnTop;

	public ImageGallerySubcategoryAdapterEvent(Context context,
											   ArrayList<EventElement> imageGallerySubcategories, boolean isLayoutOnTop) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (type == TYPE_ONE_COLUMN) {
			...
			EventElement model1 = mImageGallerySubcategories.get(position * 2);
			...
			EventElement model2 = mImageGallerySubcategories.get(position * 2 + 1);
