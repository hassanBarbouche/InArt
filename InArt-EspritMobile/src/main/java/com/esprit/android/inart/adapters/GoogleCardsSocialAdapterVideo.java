...
import com.esprit.android.inart.VideoElement;
...
public class GoogleCardsSocialAdapterVideo extends ArrayAdapter<VideoElement>
	...
	public GoogleCardsSocialAdapterVideo(Context context, List<VideoElement> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ParseQuery<ParseUser> query = ParseUser.getQuery();
					...
					VideoElement item = getItem(position);
		...
		ImageUtil.displayImage(holder.image, item.url_photo, null);
