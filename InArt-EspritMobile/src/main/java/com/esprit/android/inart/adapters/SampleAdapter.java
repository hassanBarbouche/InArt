...
public class SampleAdapter extends ArrayAdapter<String> {
    ...
    public SampleAdapter(final Context context, final int textViewResourceId) {
        ...
        mBackgroundColors.add(R.drawable.newss);
        mBackgroundColors.add(R.drawable.artistss);
        mBackgroundColors.add(R.drawable.eventss);
        mBackgroundColors.add(R.drawable.spacess);
        mBackgroundColors.add(R.drawable.forumss);
        mBackgroundColors.add(R.drawable.postss);
    }
