...
import com.esprit.android.inart.models.ImageGalleryCategoryModel;
...
public class DummyContent {
	...
	public static ArrayList<DummyModel> getSocialDummyList() {
		ArrayList<DummyModel> list = new ArrayList<>();
		list.add(new DummyModel(0, "", "My Music", R.string.material_icon_play));
		list.add(new DummyModel(1, "", "My Photos", R.string.material_icon_image_box));
		list.add(new DummyModel(2, "", "My Moovies", R.string.material_icon_video));
		list.add(new DummyModel(3, "", "My Events", R.string.material_icon_party));
		list.add(new DummyModel(4, "", "My Profile", R.string.material_icon_account));
		list.add(new DummyModel(5, "", "Settings", R.string.material_icon_bike));
		return list;
	}
	public static ArrayList<DummyModel> getSocialDummyListImage() {
		...
		list.add(new DummyModel(2, R.drawable.map2));
		list.add(new DummyModel(3, R.drawable.go));
		list.add(new DummyModel(4, R.drawable.go2));
