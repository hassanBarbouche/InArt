...
import com.esprit.android.inart.adapters.GoogleCardsSocialAdapterEvent;
...
public class PhotographyListEvent extends BaseActivity implements
		OnDismissCallback {
	...
	private GoogleCardsSocialAdapterEvent mGoogleCardsAdapter;
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		query.whereEqualTo("Genre", "Photography");
		query.findInBackground(new FindCallback<ParseObject>() {
			public void done(List<ParseObject> conThus, ParseException e) {
				if (e == null) {
					...
					mGoogleCardsAdapter = new GoogleCardsSocialAdapterEvent(getApplicationContext(),mang
					);
