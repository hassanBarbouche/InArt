...
public class SampleListFragment extends ScrollTabHolderFragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		mListView.setAdapter(new ArrayAdapter<String>(getActivity(), R.layout.list_item2, android.R.id.text1, mListItems));
		
		if(Detail.NEEDS_PROXY){//in my moto phone(android 2.1),setOnScrollListener do not work well
