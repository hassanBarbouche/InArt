       ...
       final String name = reportingPref.getString("name", "");
        ...
        postbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ParseFile fileimage = new ParseFile("EventImage", image);
                ...
                ParseObject parseObject = new ParseObject("Event");
                //  parseObject.put("AudioFile", parseAudioFile);
                parseObject.put("EventName", Eventname);
                parseObject.put("EventImage", fileimage);
        ...
        esm.setText(name);
        Glide.with(PostEventActivity.this)
                .load(imgurl)
                .into(myimage);
