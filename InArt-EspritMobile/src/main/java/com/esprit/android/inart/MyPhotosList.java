...
public class MyPhotosList extends BaseActivity {
		...
		query.findInBackground(new FindCallback<ParseObject>() {
            public void done(List<ParseObject> conThus, ParseException e) {
                if (e == null) {
                    ...
                    BaseAdapter adapter = new ImageGallerySubcategoryAdapter(getBaseContext(), (ArrayList<PhotoElement>) mang, mIsLayoutOnTop);
